...
#endif
#if QR_APP || RSS_READER || HA_CONTROL || STOPWATCH || MOON_SUN_APP || SUBNET_CALC_APP || WORLD_CLOCK_APP || PINOUT_WALLET_APP || RTC_DRIFT_LAB_APP || APPLE_JOKE
    {
        count = count + 1;
...
void initSettingsMenu()
{
...
#if FS_UPLOAD
    {
        ...
        buttons[count] = {MENU_FS_UPLOAD, "wifiIcon", switchFsUpload};
    }
#endif
#if PRESENCE_BEACON
    {
        count = count + 1;
        buttons[count] = {MENU_PRESENCE_BEACON, "presence/beacon", switchPresenceBeaconCfg};
    }
#endif
...
void initUtilitiesMenu()
{
    ...
    {
        count = count + 1;
        buttons[count] = {MENU_PINOUT_WALLET, "debug", switchPinoutWallet};
    }
#endif
...
void initGamesMenu()
{
...
#if CHESS
    {
        ...
        buttons[count] = {MENU_CHESS, "chess/chess", switchChessApp};
    }
#endif
    count = count + 1;
